...
public class BuildingUpdateResponse {
	...
	public BuildingUpdateResponse() {

	}

	public BuildingUpdateResponse(Builder builder) {
	...
	public static class Builder {
		...
		public BuildingUpdateResponse build() {
			BuildingUpdateResponse result = new BuildingUpdateResponse(this);
			return result;
		}
	}
}
